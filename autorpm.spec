...
AutoRPM jest programem, który może wykonywać dowolną kombinację
następujących czynności: mirrorowanie pakietów rpm z podanego adresu
serwera FTP, aktualizowanie bazy zainstalowanych pakietów względem
zawartości serwera FTP lub katalogu lokalnego. Autorpm jest dość łatwo
konfigurowalny i posiada dość duże możliwości. Można go używać w
trybie wsadowym i interakcyjnym gdzie posiada dość przyjemny
interfejs.
